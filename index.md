...
- **Computer Vision**: 
    3D Object Detection, Multi-view 3D Reconstruction, 3D Gaussian Splatting
- **Multimodal AI**: 
    Large Language Models (LLMs), Vision-Language Models (VLMs), Retrieval-Augmented Generation (RAG), Multimodal Knowledge Graphs (MMKGs), Recommender Systems
- **Machine Learning**: 
    Domain Generalization and Domain Adaptation, Neural Architecture Design (NAD)
