...
const navItems = [
  { name: 'Home', path: '/#home', id: 'home', icon: true },
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={clsx(
                'relative rounded-full font-medium transition-colors duration-300 whitespace-nowrap',
                item.icon ? 'p-2 md:px-4 md:py-2' : 'px-2 md:px-6 py-2 text-[11px] md:text-sm',
            ...
            >
              ...
              <span className="relative z-10">
                {item.icon ? <Home size={16} className="md:w-[18px]" /> : item.name}
              </span>
            </Link>
          );
        })}
